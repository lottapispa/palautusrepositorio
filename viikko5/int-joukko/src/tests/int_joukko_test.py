...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.kuuluuko_alkio_joukkoon(11))
        joukko.poista_alkio(11)
        self.assertFalse(joukko.kuuluuko_alkio_joukkoon(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.kuuluuko_alkio_joukkoon(10))
        self.assertFalse(self.joukko.kuuluuko_alkio_joukkoon(5))
        self.assertTrue(self.joukko.kuuluuko_alkio_joukkoon(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista_alkio(3)
        self.assertFalse(self.joukko.kuuluuko_alkio_joukkoon(3))
    ...
    def test_palautetaan_oikea_taulukko(self):
        ...
        vastaus = self.joukko.muuta_lista_kokonaisluvuiksi()
    ...
    def test_yhdiste(self):
        ...
        vastauksen_luvut = tulos.muuta_lista_kokonaisluvuiksi()
