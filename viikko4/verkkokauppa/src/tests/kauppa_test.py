...
class TestKauppa(unittest.TestCase):
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla_1_tuote(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)                
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_2_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_pankin_metodia_tilisiirto_kutsutaan_2_samaa_tuotetta(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.lisaa_koriin(2)
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        self.pankki_mock.tilisiirto.assert_called_with("pekka", self.viitegeneraattori_mock.uusi.return_value, "12345", "33333-44455", 14)

    def test_pankin_metodia_tilisiirto_kutsutaan_kun_loppunut_tuote(self):
        # tehdään ostokset
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
